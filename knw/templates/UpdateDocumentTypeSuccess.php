...
<div class="formpage4col">
    ...
    <div id="status"></div>
    <div class="outerbox">
        <div class="mainHeading"><h2><?php echo __("Edit Document Type") ?></h2></div>
        <form name="frmSave" id="frmSave" method="post"  action="">
            ...
            <br class="clear"/>
            <div class="leftCol">
                <label for="txtLocationCode"><?php echo __("Document Type Name") ?> </label>
                <input name="txtbtid" type="hidden" value="<?php echo $benifittypelist->getKnw_doc_id() ?>"/>
            </div>
            <div class="centerCol">
                <textarea id="txtJobTitleDesc" class="formTextArea" tabindex="1" name="txtName" type="text"><?php echo $benifittypelist->getKnw_doc_name() ?></textarea>
            </div>
            <div class="centerCol">
                <textarea id="txtJobTitleDesc" class="formTextArea" tabindex="2" name="txtNamesi" type="text"><?php echo $benifittypelist->getKnw_doc_name_si() ?></textarea>
            </div>
            <div class="centerCol">
                <textarea id="txtJobTitleComments" class="formTextArea" tabindex="3" name="txtNameta" type="text"><?php echo $benifittypelist->getKnw_doc_name_ta() ?></textarea>
            </div>
            <br class="clear"/>
...
<?php } ?>
                       ...
                       $("#editBtn").click(function() {
                           ...
                           if (editMode == 1) {
                               ...
                               location.href="<?php echo url_for('knw/UpdateDocumentType?id=' . $benifittypelist->getKnw_doc_id() . '&lock=1') ?>";
                           }
                           else {
                       ...
                       $("#btnClear").click(function() {
                           ...
                           location.href="<?php echo url_for('knw/UpdateDocumentType?id=' . $benifittypelist->getKnw_doc_id() . '&lock=0') ?>";
                       });
                   });
</script>
